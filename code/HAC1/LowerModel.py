...
class LowerModel(SAC):
    ...
    def change_goal(self, goal_obs):
        self.current_goal = goal_obs.reshape(1, -1)
    ...
    def collect_rollouts(self, goal, selected_goal, is_subgoal_test):
        ...
        while should_collect_more_steps(train_freq, num_collected_steps, num_collected_episodes):
            ...
            if dones:
                infos[0]['terminal_observation']['obs'] = infos[0]['terminal_observation']['obs'].reshape(1, -1)
                infos[0]['terminal_observation']['goal'] = infos[0]['terminal_observation']['goal'].reshape(1, -1)

            goal_achieved = self.check_goal(infos[0]['goal_obs'], selected_goal)
            real_done = dones
            if goal_achieved:
                rewards = 1
            ...
            new_obs['goal'] = self.current_goal
            self._last_obs['goal'] = self.current_goal
        ...
        return new_obs, rewards, dones, infos, buffer_actions
