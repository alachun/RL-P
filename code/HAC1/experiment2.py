...
def list_files(directory):
    ...
    return file_paths
dfa = 2
'''tasks = ['p4-3-3-0-1', 'p4-3-3-0-2', 'p4-4-2-0-1', 'p4-4-2-0-2',
'p4-4-3-0-1', 'p4-4-3-0-2', 'p4-5-2-0-1', 'p4-5-2-0-2', 'p4-5-3-0-1',
'p4-5-3-0-2']'''
tasks = ['p4-4-2-0-1', 'p4-4-2-0-2',
'p4-4-3-0-1', 'p4-4-3-0-2', 'p4-5-2-0-1', 'p4-5-2-0-2', 'p4-5-3-0-1',
'p4-5-3-0-2']
...
for task in tasks:
    rlp_log = 'log/PDDLEnvCitycar/RL-P/' + task + '/dfa' + str(dfa)
    hac_log = 'log/PDDLEnvCitycar/HAC/' + task + '/dfa' + str(dfa)
    a2c_log = 'log/PDDLEnvCitycar/A2C/' + task + '/dfa' + str(dfa)
    rlp_nomask_log = 'log/PDDLEnvCitycar/RL-P(no mask)/' + task + '/dfa' + str(dfa)
    ...
    plt.title(task, fontsize=28, fontweight='bold', color='blue')
    # plt.legend(fontsize=24, loc='upper left')
    plt.ylim(0, None)
    plt.grid(True)
    plt.tight_layout()
    plt.savefig('fig/' + task + "_dfa" + str(dfa))
