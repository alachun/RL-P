...
for i in range(10):
    os.system("python train2.py -i " + str(i) + " -d 1 -l 4 -t " + str(training_time3[i]))
for i in range(8):
    os.system("python train3.py -i " + str(i + 2) + " -d 2 -l 4 -t " + str(training_time4[i]))

for i in range(10):
    os.system("python train2.py -i " + str(i) + " -d 1 -l 5 -t " + str(training_time3[i]))
for i in range(8):
    os.system("python train3.py -i " + str(i + 2) + " -d 2 -l 5 -t " + str(training_time4[i]))
