...
'''citycar(三个连续时序+3F)的problem问题，用于规划器调用'''
def get_citycar_problem(graph_len,car_sum,garage_sum,road_sum,garage_at_jun,car_start_garage,car_arrived_jun,place):
    ...
    trans.add_effect(state,True)
    #三个连续时序+F(a & (F(b & (F c)))) 要求小车要经过某点
    trans.add_effect(q1,False,condition=And(q1,arrived(cars[0],junctions[car_arrived_index[0]]),
                                            Not(arrived(cars[1],junctions[car_arrived_index[1]])),
                                            Not(arrived(cars[2],junctions[car_arrived_index[2]]))))
    trans.add_effect(q3, True, condition=And(q1, arrived(cars[0], junctions[car_arrived_index[0]]),
                                              Not(arrived(cars[1], junctions[car_arrived_index[1]])),
                                              Not(arrived(cars[2], junctions[car_arrived_index[2]]))))
    trans.add_effect(q1,False,condition=And(q1,Or(arrived(cars[1],junctions[car_arrived_index[1]]),
                                                  arrived(cars[2], junctions[car_arrived_index[2]]))))
    trans.add_effect(q2, True, condition=And(q1, Or(arrived(cars[1], junctions[car_arrived_index[1]]),
                                                     arrived(cars[2], junctions[car_arrived_index[2]]))))
    trans.add_effect(q3, False, condition=And(q3, arrived(cars[0], junctions[car_arrived_index[0]]),
                                              arrived(cars[1], junctions[car_arrived_index[1]]),
                                              Not(arrived(cars[2], junctions[car_arrived_index[2]]))))
    trans.add_effect(q4, True, condition=And(q3, arrived(cars[0], junctions[car_arrived_index[0]]),
                                              arrived(cars[1], junctions[car_arrived_index[1]]),
                                              Not(arrived(cars[2], junctions[car_arrived_index[2]]))))
    trans.add_effect(q3, False, condition=And(q3, Or(arrived(cars[2], junctions[car_arrived_index[2]]),
                                                     Not(arrived(cars[0], junctions[car_arrived_index[0]])))))
    trans.add_effect(q2, True, condition=And(q3, Or(arrived(cars[2], junctions[car_arrived_index[2]]),
                                                     Not(arrived(cars[0], junctions[car_arrived_index[0]])))))
    trans.add_effect(q4, False, condition=And(q4, arrived(cars[0], junctions[car_arrived_index[0]]),
                                              arrived(cars[1], junctions[car_arrived_index[1]]),
                                              arrived(cars[2], junctions[car_arrived_index[2]])))
    trans.add_effect(q5, True, condition=And(q4, arrived(cars[0], junctions[car_arrived_index[0]]),
                                              arrived(cars[1], junctions[car_arrived_index[1]]),
                                              arrived(cars[2], junctions[car_arrived_index[2]])))
    trans.add_effect(q4, False, condition=And(q4, Or(Not(arrived(cars[1], junctions[car_arrived_index[1]])),
                                                     Not(arrived(cars[0], junctions[car_arrived_index[0]])))))
    trans.add_effect(q2, True, condition=And(q4, Or(Not(arrived(cars[1], junctions[car_arrived_index[1]])),
                                                     Not(arrived(cars[0], junctions[car_arrived_index[0]])))))
    trans.add_effect(q5, False, condition=And(q5, Or(Not(arrived(cars[1], junctions[car_arrived_index[1]])),
                                                     Not(arrived(cars[2], junctions[car_arrived_index[2]])),
                                                     Not(arrived(cars[0], junctions[car_arrived_index[0]])))))
    trans.add_effect(q2, True, condition=And(q5, Or(Not(arrived(cars[1], junctions[car_arrived_index[1]])),
                                                     Not(arrived(cars[2], junctions[car_arrived_index[2]])),
                                                     Not(arrived(cars[0], junctions[car_arrived_index[0]])))))
    trans.add_effect(q6,False,condition=And(q6,at_car_jun(cars[0], junctions[place_index[0]]),
                                            Not(at_car_jun(cars[1], junctions[place_index[1]]))))
    trans.add_effect(q7, True, condition=And(q6, at_car_jun(cars[0], junctions[place_index[0]]),
                                              Not(at_car_jun(cars[1], junctions[place_index[1]]))))
    trans.add_effect(q6, False, condition=And(q6, at_car_jun(cars[0], junctions[place_index[0]]),
                                              at_car_jun(cars[1], junctions[place_index[1]]),
                                              Not(at_car_jun(cars[2], junctions[place_index[2]]))))
    trans.add_effect(q8, True, condition=And(q6, at_car_jun(cars[0], junctions[place_index[0]]),
                                              at_car_jun(cars[1], junctions[place_index[1]]),
                                              Not(at_car_jun(cars[2], junctions[place_index[2]]))))
    trans.add_effect(q6, False, condition=And(q6, at_car_jun(cars[0], junctions[place_index[0]]),
                                              at_car_jun(cars[1], junctions[place_index[1]]),
                                              at_car_jun(cars[2], junctions[place_index[2]])))
    trans.add_effect(q9, True, condition=And(q6, at_car_jun(cars[0], junctions[place_index[0]]),
                                              at_car_jun(cars[1], junctions[place_index[1]]),
                                              at_car_jun(cars[2], junctions[place_index[2]])))
    trans.add_effect(q7, False, condition=And(q7, at_car_jun(cars[1], junctions[place_index[1]]),
                                             Not(at_car_jun(cars[2], junctions[place_index[2]]))))
    trans.add_effect(q8, True, condition=And(q7, at_car_jun(cars[1], junctions[place_index[1]]),
                                              Not(at_car_jun(cars[2], junctions[place_index[2]]))))
    trans.add_effect(q7, False, condition=And(q7, at_car_jun(cars[1], junctions[place_index[1]]),
                                              at_car_jun(cars[2], junctions[place_index[2]])))
    trans.add_effect(q9, True, condition=And(q7, at_car_jun(cars[1], junctions[place_index[1]]),
                                              at_car_jun(cars[2], junctions[place_index[2]])))
    trans.add_effect(q8, False, condition=And(q8, at_car_jun(cars[2], junctions[place_index[2]])))
    trans.add_effect(q9, True, condition=And(q8, at_car_jun(cars[2], junctions[place_index[2]])))
...
if __name__=='__main__':
    ...
    params={
        'fast_downward_alias':'seq-sat-fdss-2023',
        'fast_downward_search_time_limit':'150s'
    }
